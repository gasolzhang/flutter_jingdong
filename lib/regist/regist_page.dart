...
import 'package:jingdong/regist/regist_presenter.dart';
...
class RegistState extends BaseState<RegistPage, RegistPresenter> {
  ...
  @override
  RegistPresenter newPresenter() {
    return RegistPresenter();
  }

  void onRegistSuccess(UserModel model) {
